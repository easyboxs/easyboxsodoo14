odoo.define('pos_product_creation.product_create_popup', function(require) {
    ...
    class ProducCreatePopup extends AbstractAwaitablePopup {
        constructor() {
            super(...arguments);
    ...
    ProducCreatePopup.template = 'ProducCreatePopup';
    ProducCreatePopup.defaultProps = {
        confirmText: 'Ok',
        cancelText: 'Cancel',
        array: [],
        title: 'Create ?',
    ...
    Registries.Component.add(ProducCreatePopup);

    return ProducCreatePopup;
});